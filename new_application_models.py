...
class NewSharePurchase(models.Model):
    STATUS_CHOICES = [
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='new_share_purchases')
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    reviewed_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='reviewed_new_shares')
